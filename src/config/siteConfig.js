export const siteConfig = {
  ...
  content: {
    ...
    booking: {
      ...
      waitlist: {
        chipLabel: 'רוצה גם: {time} (תפוס)',
        chipRemoveLabel: 'הסרה',
        takenHint: 'השעה הזו תפוסה. אפשר להצטרף לרשימת ההמתנה עבורה, ולבחור שעה פנויה נוספת כדי לשמור תור.',
        promptTitle: 'התור שלך נקבע ✅',
        promptQuestion: 'רוצה גם להיכנס לרשימת המתנה למועד נוסף?',
        promptSummary: '{service} בשעה {time}',
        yesLabel: 'כן, רוצה',
        noLabel: 'לא תודה',
        joiningLabel: 'שולח...',
        joinedTitle: 'נרשמת לרשימת ההמתנה!',
        joinedBody: 'נעדכן אותך בוואטסאפ אם יתפנה מקום.',
        demoJoinedBody: 'זהו דמו — לא נשלחה בקשה אמיתית לרשימת ההמתנה.',
