    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          {
            heading: 'עוגיות, גופנים ומפה חיצוניים',
            paragraphs: [
              ...
              'האתר משתמש ב-Google Maps להצגת מיקום העסק. טעינת המפה עשויה להעביר נתוני שימוש (כגון כתובת IP) ל-Google, בהתאם למדיניות הפרטיות של Google.',
            ],
          },
        ],
        contact: {
